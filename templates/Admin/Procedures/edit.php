 ...
 */
$this->assign('title', 'Modifier la procédure');
?>
...
<nav class="flex mb-8" aria-label="Breadcrumb">
    <ol role="list" class="flex items-center space-x-4">
        ...
        <li>
            <div class="flex items-center">
                <i class="fa-solid fa-chevron-right text-gray-400 text-xs"></i>
                <span class="ml-4 text-sm font-medium text-gray-900">Modifier : <?= h($procedure->name) ?></span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl overflow-hidden">
        <div class="border-b border-gray-200 bg-gray-50 px-4 py-5 sm:px-6">
            <h2 class="text-xl font-semibold leading-7 text-gray-900">Modifier la procédure</h2>
            <p class="mt-1 text-sm leading-6 text-gray-500">Mettez à jour les informations de cette procédure bancaire.</p>
        </div>
